          ...
          <div className="flex flex-col lg:flex-row items-center gap-4 sm:gap-6">
            <h2 className="order-1 mt-2 tracking-tight text-center text-balance !leading-tight font-bold text-5xl md:text-6xl text-gray-900">
              What our <span className="relative px-2">
                customers <Icons.underline className="hidden sm:block pointer-events-none absolute insert-x-0 -bottom-6 text-green-500" />
                </span> say
            </h2>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  last phone cases. This one, besides a barely noticeable scratchmarks
                  on the corner, <span className="p-0.5 bg-slate-800 text-white"> 
